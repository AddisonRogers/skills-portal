...
ALTER TABLE "user" ADD COLUMN "location_id" integer;--> statement-breakpoint
ALTER TABLE "user" ADD COLUMN "reports_to_user_id" text;--> statement-breakpoint
...
ALTER TABLE "user_favorite_skill" ADD CONSTRAINT "user_favorite_skill_skill_id_skill_id_fk" FOREIGN KEY ("skill_id") REFERENCES "public"."skill"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user" ADD CONSTRAINT "user_reports_to_user_id_user_id_fk" FOREIGN KEY ("reports_to_user_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user" ADD CONSTRAINT "user_location_id_user_id_fk" FOREIGN KEY ("location_id") REFERENCES "public"."user"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "user_skill" ADD CONSTRAINT "user_skill_user_id_skill_id_unique" UNIQUE("user_id","skill_id");