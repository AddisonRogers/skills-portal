  ...
  return (
    <main style={{ padding: 24, fontFamily: 'ui-sans-serif, system-ui' }}>
      ...
      <ul style={{ marginBottom: 16 }}>
        {missingKeys.map((k) => (
          <li key={k} style={{ fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace' }}>
            {k}
          </li>
        ))}
      </ul>
      ...
      <p style={{ marginBottom: 8 }}>
        Add them to your environment (for local dev, typically <code>.env.local</code>), using
        <code> .env.example</code> as a reference.
      </p>

      <p style={{ color: '#666' }}>After setting them, restart the Next.js server.</p>
    </main>
  );
}
