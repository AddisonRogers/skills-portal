...
export default async function AdminDashboard() {
  ...
  const skillsAcquiredCount = await db.select({ count: count() }).from(userSkill);
    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-4xl font-bold">{skillsAcquiredCount[0]?.count || 0}</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="cursor-pointer hover:bg-gray-50 transition-colors">
            ...
            <CardContent>
              <a href="/admin/skills" className="text-blue-600 hover:underline">Go to Skills Management →</a>
            </CardContent>
          </Card>
          ...
          <Card className="cursor-pointer hover:bg-gray-50 transition-colors">
            <CardHeader>
              ...
              <CardDescription>See users and their skill progression</CardDescription>
            </CardHeader>
            <CardContent>
              <a href="/admin/users" className="text-blue-600 hover:underline">Go to Users & Skills →</a>
            </CardContent>
          </Card>
        </div>
      </div>
