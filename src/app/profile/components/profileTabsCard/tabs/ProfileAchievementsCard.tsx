...
const achievements: Achievements[] = [
    ...
    },
    {
        ...
        achievementDescription: "Take part in two projects at work to enhance practical experience.",
        baseLevel: 1,
        nextLevel: 2,
        currentLevel: 1,
        rank: 1,
    },
    {
        ...
        achievementDescription: "Acquire new skills relevant to your professional growth.",
        baseLevel: 3,
        nextLevel: 5,
        currentLevel: 4,
        rank: 2,
    },
    {
        ...
        achievementDescription: "Provide mentorship to colleagues to foster team development.",
        baseLevel: 1,
        nextLevel: 3,
        currentLevel: 2,
        rank: 3,
    },
    {
        ...
        achievementDescription: "Successfully lead a  project from initiation to completion.",
        baseLevel: 0,
        nextLevel: 1,
        currentLevel: 0,
        rank: 4,
                    ...
                    <CardHeader className="gap-0">
                        <div className="flex items-center gap-3">
                            <div className="flex-1 min-w-0 pr-4">
                                ...
                                <LevelBar currentXP={achievement.currentLevel} length="100%" minXP={achievement.baseLevel} maxXP={achievement.nextLevel} baseLevel={achievement.baseLevel} nextLevel={achievement.nextLevel} text={false} />
                            </div>
