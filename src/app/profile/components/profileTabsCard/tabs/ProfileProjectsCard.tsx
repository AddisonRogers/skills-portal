...
const projects: UserProjects[] = [
	{
		...
		projectDescription:
			"Redesigned the customer self-service portal UI and migrated legacy components to a modern stack.",
	...
	},
	{
		...
		projectDescription:
			"Integrated external billing provider API’s and implemented retry logic and observability.",
	...
	},
	{
		...
		projectDescription:
			"Developed and deployed an AI-powered chatbot to enhance customer support and engagement on the platform.",
								...
								<div className="flex items-center">
									<div className="flex-1 min-w-0 pr-20">
										<CardTitle className="mb-0">
											<a className="mr-3 block truncate">
												{project.projectName}
											</a>
										</CardTitle>
