...
const goals: UserGoals[] = [
	{
		...
		goalDescription:
			"I want to complete the AZ-900 certification so that I have a greater understan of cloud concepts.",
	...
	},
	{
		...
		goalDescription:
			"Working on improving my understanding and application of React and Blazor. gf sdsfre rew as gtreg fdsfsd ds ",
	...
	},
	{
		...
		goalDescription:
			"I want to learn Docker to containerize applications for consistent environments across development and production.",
		status: { id: 0, label: "Active" },
		due: new Date(),
	},
];
