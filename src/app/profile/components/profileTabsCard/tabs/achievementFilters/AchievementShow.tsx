...
export type AchievementShowOptions = "All" | "Unknown" | "Bronze" | "Silver" | "Gold" | "Diamond";
...
export default function AchievementShow({showFilter, setShowFilter}: Props) {
    const toggle = () => {
        const next: AchievementShowOptions = showFilter === "All" ? "Unknown" : showFilter === "Unknown" ? "Bronze" : showFilter === "Bronze" ? "Silver" : showFilter === "Silver" ? "Gold" : showFilter === "Gold" ? "Diamond" : "All";
        setShowFilter(next);
    };
