...
export default function SkillProgressionSwitch({
  ...
  skillName: string;
  skillProgressionProp: Promise<getSkillForUserEmailResult[] | null | undefined>;
}) {
  const options = [
  ...
  const skillProgression = use<getSkillForUserEmailResult[] | null | undefined>(skillProgressionProp);
