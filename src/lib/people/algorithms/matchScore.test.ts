...
import {
	createPersonWithSkillIndex,
	personWithSkillIndex,
} from "@/lib/test/fixtures/people";
...
describe("matchScore", () => {
	it("gives a higher score if someone has more matching skills", () => {
		...
		const searchCriteriaSkillsOnly = createSearchCriteria({
			minProficiency: 0,
		});
